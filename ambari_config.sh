...
then
    ...
    /home/wce/clsadmin/charles/configs.py -u $AMBARI_USER -p $AMBARI_PASSWORD -t $AMBARI_PORT -a "set" -l $AMBARI_HOST -n $CLUSTER_NAME -c "mapred-site" -k "mapreduce.map.memory.mb" -v "7192"
    echo "Updating Custom core-site"
    /home/wce/clsadmin/charles/configs.py -u $AMBARI_USER -p $AMBARI_PASSWORD -t $AMBARI_PORT -a "set" -l $AMBARI_HOST -n $CLUSTER_NAME -c "core-site" -k "fs.cos.CloudObjectStorageMatt.access.key" -v "abcdefg1234567890"
